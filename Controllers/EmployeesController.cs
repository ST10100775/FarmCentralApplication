...

    {
        ...
        public ActionResult Login(Employee e)
        {
            ...
            using (var sha256 = SHA256.Create())
            {
                ...
                // Employee is matched to the employee table in the database to allow for login
                Employee user = db.Employees.FirstOrDefault(us => us.AdminId == e.AdminId && us.Password == pass);
